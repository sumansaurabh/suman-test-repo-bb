...
本项目使用 [`next/font`](https://nextjs.org/docs/app/building-your-application/optimizing/fonts) 来自动优化并加载 [Geist](https://vercel.com/font)，这是 Vercel 推出的全新字体系列。

## 了解更多

若要了解更多关于 Next.js 的信息，请查看以下资源：
