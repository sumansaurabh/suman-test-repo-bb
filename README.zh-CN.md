这是一个使用 [Next.js](https://nextjs.org) 的项目，通过 [`create-next-app`](https://nextjs.org/docs/app/api-reference/cli/create-next-app) 初始化。
...
部署 Next.js 应用最简单的方式是使用 Vercel 平台，它是 Next.js 创建者提供的。
