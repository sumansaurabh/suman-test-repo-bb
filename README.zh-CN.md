...
您可以通过修改 `app/page.tsx` 来开始编辑页面。编辑文件后页面会自动更新。

本项目使用 [`next/font`](https://nextjs.org/docs/app/building-your-application/optimizing/fonts) 来自动优化和加载 Vercel 的新字体家族 [Geist](https://vercel.com/font)。
...
部署 Next.js 应用最简单的方式是使用 Vercel 平台，这是 Next.js 创建者提供的。
