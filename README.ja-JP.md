...
- [Next.js を学ぶ](https://nextjs.org/learn) - 対話式の Next.js チュートリアル。
...
詳細については、[Next.js デプロイ ドキュメント](https://nextjs.org/docs/app/building-your-application/deploying) を参照してください。
